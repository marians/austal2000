...
int main( int argc, char *argv[] ) {
  ...
  for (k=0; k<Nz; k++) {
    ...
    cmin = c*(1-2*d);
    cmax = c*(1+2*d);
    fprintf(Out, "%2d %7.1lf %7.1lf %7.1lf\n", k+1, cmin, c, cmax);//-2008-09-30
  }
  fprintf(Out, "\n");                                             //-2008-09-30
  vMsg("@verif13  finished");                                     //-2008-09-30
  return 0;
}
