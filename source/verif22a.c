// ====================================================== verif22a.c
//
// Evaluation of verification 22a
// ==============================
//
...
#include "verif22a.nls"

static char *Path = "verif/22a";
...
int main( int argc, char *argv[] ) {
  ...
  int k, n;
  double c, d, cmin, cmax, z, vs=0.01, cth, kz=1;
  FILE *f;
  ...
  fprintf(Out, "\n");                                             //-2008-09-30
  vMsg("@verif22a finished");                                     //-2008-09-30
  return 0;
}
